...
""" attributeRating:[
         {"name":"comfort",          "rating":3.0      },
         {         "name":"quality",         "rating":4.0      },
         {       "name":"running",        "rating":5.0         }]
...
comments=[
    ...
    {"comments": ["this is second test", "this is second test", "this is second test", "this is second test"], 
    "rating":[
         {"name":"comfort",          "rating":3.0      },
         {         "name":"quality",         "rating":4.0      },
         {       "name":"running",        "rating":5.0         }]}
...
def ml(body):
    ...
    for i in attribute :
        ...
        c=c+1
    #attributeRating["rating"][np.isnan(int(attributeRating["rating"]))]=0
     #print(attributeRating)   
